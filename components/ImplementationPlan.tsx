...
export const ImplementationPlan: React.FC<{ planText: string }> = ({ planText }) => {
  ...
  return (
    <div className="w-full bg-brand-card/50 p-6 sm:p-8 rounded-2xl border border-slate-800">
      <div className="mb-8">
        ...
        <div className="w-full bg-slate-700/50 rounded-full h-3.5 shadow-inner">
            <motion.div 
                className="bg-gradient-to-r from-brand-accent to-orange-400 h-3.5 rounded-full"
                initial={{ width: 0 }}
